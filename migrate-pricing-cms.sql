-- SQL Migration Script: Populate Pricing CMS Data
-- Run this in Supabase SQL Editor to populate all pricing data
...
SET content = '{
  ...
  "appDevelopment": {
    ...
    "tier2": {
      ...
      "includes": "Cross-platform (Flutter / React Native)\nAuthentication\nDatabase + APIs\nAdmin dashboard\nPush notifications\nAnalytics",
  ...
  "growthMarketing": {
    ...
    "tier2": {
      ...
      "includes": "Funnel strategy (TOF/MOF/BOF)\nUp to 3 ad campaigns\nAd copywriting\nCreative variations\nRetargeting setup\nWeekly performance check",
    ...
    "tier3": {
      ...
      "includes": "Full-funnel performance marketing\nConversion Rate Optimization (CRO)\nAdvanced retargeting\nMarketing automation\nDedicated account manager",
